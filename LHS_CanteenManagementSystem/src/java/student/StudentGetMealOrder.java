...
public class StudentGetMealOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
               ut.begin();
               List<Mealorderb> mealorders = em.createQuery("SELECT m FROM Mealorderb m WHERE m.studentid = :studentid").setParameter("studentid",student.getStudentid()).getResultList();
               ut.commit();
